...
export const ImageCropContent = ({
	...
	return (
		...
		>
			{imgSrc && (
				// biome-ignore-start lint/performance/noImgElement: imgSrc is a dataUrl and cannot render by next/image Image component
				<img
					alt="crop"
					className="size-full"
					onLoad={onImageLoad}
					...
					src={imgSrc}
				/>
				// biome-ignore-end lint/performance/noImgElement: imgSrc is a dataUrl and cannot render by next/image Image component
			)}
		</ReactCrop>
	);
};
